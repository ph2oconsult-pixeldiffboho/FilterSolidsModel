  ...
  },
  {
    ...
    items: [
      ...
      { cite: "Anderson, L. et al. (2023). Adapting direct filtration to increasing source water dissolved organic carbon. AWWA Water Science 5(5), e1352.",
        used_for: "Calibration target for CN regime / direct filtration: pilot-scale UFRV 313 m³/m² (median), filter run time 70 h (median), terminal head loss 1.98 m for adapted GAC/Ant/Sand filter. Model agrees within ±5% on UFRV and run length when realistic source NTU (~3 NTU, typical DOC-rich direct filtration source) is used; result varies inversely with influent NTU." },
      { cite: "Dentel, S.K. (1988). Mechanisms of coagulation with aluminum salts. JAWWA 80(4), 187–198.",
        used_for: "Charge-neutralisation model — partial coverage of negatively charged colloids by Al(OH)₃. Justifies near-stoichiometric mass yield for alum_cn (precipitate forms at pH 5–6 even though speciation differs from sweep)." },
